...
cd $CURRENT_DIR/$DIR
#名称修改
sed -i 's/TVBox/TVBox/g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
...
#添加PY支持
wget --no-check-certificate -qO- "https://raw.githubusercontent.com/yunboxtv/TVBoxDIY/main/DIY/pyramid.aar" -O $CURRENT_DIR/$DIR/app/libs/pyramid.aar
